...
public class Game{
	...
	public Game(Window window, int x_max, int y_max){
		...
		for(int i = 0; i < this.x_max; i++){
			...
			int j= rand.nextInt(this.x_max); //nouvelle pos en x, nextInt donne un random
		...
		// Creating Barre de vie for le h�ros
		this.lifeHero = new LifeWindow(200+50*x_max,0,Color.GREEN, "Vie du H�ros");
